...
| Story | Titre | Statut |
|---|---|---|
| 4.1 | "Votre habituel ?" — HabitualBanner | ❌ À faire |
| 4.2 | "Souvent commandé avec..." suggestions croisées | ⚠️ Statique fait, dynamique DB manque |
| 4.3 | Preuve sociale compteur commandes dynamique | ❌ À faire |
